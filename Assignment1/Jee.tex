...
\item  Find the indefinite integral $\int$$(\frac{1}{\sqrt[3]{x} + \sqrt[4]{4}}+\frac{\ln (1+\sqrt[6]{x})}{\sqrt[3]{x}+\sqrt{x}}$     {$(1992 - 4 Marks)$} 
...
\item   Evaluate $\int \sin^{-1} (\frac{2x + 2}{\sqrt{4x^{2}+8x+13}})dx$        {${(2001 - 5 Marks)}$}  

\item  For any natural number m , evaluate \\
${\int(x^{3m} + x^{2m}+x^{m})(2x^{2m}+3x^{m}+6)^{1/m}dx,x>0}$       {$(2002 - 5 Marks)$} 
